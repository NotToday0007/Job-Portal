        ...
        try {
            ...
            jobData.forEach((job) => {
                ...
                <tr>
                    ...
                    <td>${formattedDate}</td>
                     <td>${job['applied_jobs_count'] || 0}</td>
                    <td>${status}</td>
                    <td>
...
<li>
    <a href="/jobs/edit/${job['id']}" class="dropdown-item" >
        <i class="fa fa-edit" aria-hidden="true"></i> Edit
    </a>
</li>
<li><a href="#" class="dropdown-item" onclick="deleteJob(event, ${job['id']})"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>`;
    ...
    try {
        let res = await axios.post('/job/delete', {
            id: jobId
        });
